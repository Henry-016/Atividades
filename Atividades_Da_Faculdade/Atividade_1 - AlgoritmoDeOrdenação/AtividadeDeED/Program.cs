...
public class AlgoritmosDeOrdenacao
{
    ...
    public static void Main(string[] args)
    {
        ...
        List<int> copia1 = new List<int>(listaComMil);
        List<int> copia2 = new List<int>(listaComMil);
        List<int> copia3 = new List<int>(listaComMil);
        ...
        Console.WriteLine("\nTestando ordenação:");
        Console.WriteLine("Lista original:  " + string.Join(", ", listaComMil));
        Console.WriteLine();
        Console.WriteLine("Bubble Sort:     " + string.Join(", ", BubbleSort(listaComMil)));
        Console.WriteLine();
        Console.WriteLine("Selection Sort:  " + string.Join(", ", SelectionSort(listaComMil)));
        Console.WriteLine();
        Console.WriteLine("Quick Sort:      " + string.Join(", ", QuickSort(listaComMil)));
    }
}